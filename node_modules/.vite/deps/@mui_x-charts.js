import {
  Portal
} from "./chunk-2L34BHFG.js";
import {
  Typography_default
} from "./chunk-BQDPFPDZ.js";
import {
  require_react_dom
...
import {
  ...
  useSlotProps
} from "./chunk-X4FGS7JQ.js";
import "./chunk-EGZQX2DN.js";
import "./chunk-FMFFUJ5P.js";
import {
  useTheme
} from "./chunk-43WHE6SP.js";
import {
  Box_default
} from "./chunk-AATFOTM6.js";
import "./chunk-QPKA2PSD.js";
import {
  HTMLElementType,
  chainPropTypes,
  exactProp,
  ...
  useForkRef,
  useId
} from "./chunk-447XBTIL.js";
import {
  styled_default
} from "./chunk-Q6FTGRAT.js";
import {
  _extends,
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(React19.Fragment, {
...
var InteractionContext = React20.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React20.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
...
function ChartsVoronoiHandler(props) {
  ...
  const {
    series,
    seriesOrder
  } = React30.useContext(SeriesContext).scatter ?? {};
  const voronoiRef = React30.useRef({});
  ...
  }, [svgRef, dispatch, left2, width, top2, height, yAxis, xAxis, voronoiMaxRadius, onItemClick]);
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React32.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React33.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React33.createContext(init));
...
var HighlighContext = React34.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React34.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
  ...
  return (0, import_jsx_runtime36.jsx)(HighlighContext.Provider, {
    value,
    children
  });
}
...
var _excluded8 = ["id", "dataIndex", "classes", "color", "highlightScope", "slots", "slotProps", "style", "onClick"];
...
function BarElement(props) {
  ...
  return (0, import_jsx_runtime37.jsx)(Bar, _extends({}, barProps));
}
...
var _excluded9 = ["skipAnimation", "onItemClick"];
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(React37.Fragment, {
    children: transition((style, {
      seriesId,
      dataIndex,
      color: color2,
      highlightScope
    }) => (0, import_jsx_runtime38.jsx)(BarElement, _extends({
      id: seriesId,
      dataIndex,
      highlightScope,
      color: color2
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React38.useRef({
    x: -1,
    y: -1
  });
  React38.useEffect(() => {
...
var ChartsSurface = React39.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
  ...
  return (0, import_jsx_runtime40.jsxs)(ChartChartsSurfaceStyles, _extends({
    ...
    children: [(0, import_jsx_runtime39.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime39.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
var ChartContainer = React40.forwardRef(function ChartContainer2(props, ref) {
  const {
    width,
    height,
    series,
  ...
  useReducedMotion2();
  return (0, import_jsx_runtime41.jsx)(DrawingProvider, {
    width,
    height,
    margin,
    svgRef,
    children: (0, import_jsx_runtime41.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime41.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime41.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime41.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime41.jsx)(ChartsSurface, {
              width,
              height,
              ref: handleRef,
              sx,
...
var ResponsiveChartContainer = React42.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded11);
  const [containerRef, width, height] = useChartContainerDimensions(inWidth, inHeight);
  return (0, import_jsx_runtime42.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width && height ? (0, import_jsx_runtime42.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    })) : null
...
var BarChart = React43.forwardRef(function BarChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime44.jsxs)(ResponsiveChartContainer, {
    ...
    children: [onAxisClick && (0, import_jsx_runtime43.jsx)(ChartsOnAxisClickHandler, {
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime43.jsx)(ChartsAxisHighlight, _extends({}, defaultizedAxisHighlight)), (0, import_jsx_runtime43.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
...
var useAnimatedPath = (path2, skipAnimation2) => {
  ...
  const interpolator = React44.useMemo(() => previousPath ? string_default(previousPath, path2) : () => path2, [previousPath, path2]);
  const {
    value
  } = useSpring({
    from: {
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime46.jsxs)(React45.Fragment, {
    children: [(0, import_jsx_runtime45.jsx)("clipPath", {
      ...
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime45.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
var _excluded13 = ["id", "classes", "color", "highlightScope", "slots", "slotProps", "onClick"];
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime47.jsx)(Area, _extends({}, areaProps));
}
...
var _excluded14 = ["slots", "slotProps", "onItemClick", "skipAnimation"];
...
var _excluded15 = ["d", "skipAnimation", "ownerState"];
...
var _excluded16 = ["id", "classes", "color", "highlightScope", "slots", "slotProps", "onClick"];
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime51.jsx)(Line, _extends({}, lineProps));
}
...
var _excluded17 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
...
var _excluded18 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "highlightScope", "onClick", "skipAnimation"];
  ...
  return (0, import_jsx_runtime56.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        return (0, import_jsx_runtime56.jsx)(Element2, _extends({
          id: seriesId,
          color: series[seriesId].color,
          x: x2,
          y: y2
...
var LineChart = React55.forwardRef(function LineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime58.jsxs)(ResponsiveChartContainer, {
    ...
    sx,
    disableAxisListener: (tooltip == null ? void 0 : tooltip.trigger) !== "axis" && (axisHighlight == null ? void 0 : axisHighlight.x) === "none" && (axisHighlight == null ? void 0 : axisHighlight.y) === "none" && !onAxisClick,
    children: [onAxisClick && (0, import_jsx_runtime57.jsx)(ChartsOnAxisClickHandler, {
      onAxisClick
    }), grid && (0, import_jsx_runtime57.jsx)(ChartsGrid, {
      vertical: grid.vertical,
      horizontal: grid.horizontal
    }), (0, import_jsx_runtime58.jsxs)("g", {
      clipPath: `url(#${clipPathId})`,
      children: [(0, import_jsx_runtime57.jsx)(AreaPlot, {
        slots,
        slotProps,
        onItemClick: onAreaClick,
        skipAnimation: skipAnimation2
      }), (0, import_jsx_runtime57.jsx)(LinePlot, {
        slots,
        slotProps,
        onItemClick: onLineClick,
        skipAnimation: skipAnimation2
      })]
    }), (0, import_jsx_runtime57.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime57.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime57.jsx)(MarkPlot, {
      slots,
      slotProps,
      onItemClick: onMarkClick,
      skipAnimation: skipAnimation2
    }), (0, import_jsx_runtime57.jsx)(LineHighlightPlot, {
      slots,
      slotProps
    }), (0, import_jsx_runtime57.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime57.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime57.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
...
var _excluded24 = ["classes", "color", "cornerRadius", "dataIndex", "endAngle", "highlightScope", "id", "innerRadius", "isFaded", "isHighlighted", "onClick", "outerRadius", "paddingAngle", "startAngle"];
...
function PieArc(props) {
  ...
  const getInteractionItemProps = useInteractionItemProps(highlightScope);
  return (0, import_jsx_runtime59.jsx)(PieArcRoot, _extends({
...
function useTransformData(series) {
  ...
  const getHighlightStatus = React57.useCallback((dataIndex) => {
...
var _excluded25 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "onItemClick", "skipAnimation"];
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime60.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index2) => {
      ...
      return (0, import_jsx_runtime60.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
var _excluded27 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime61.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
true ? PieArcLabel.propTypes = {
  ...
  formattedArcLabel: import_prop_types39.default.string,
...
var _excluded28 = ["arcLabel", "arcLabelMinAngle", "arcLabelRadius", "cornerRadius", "data", "faded", "highlighted", "highlightScope", "id", "innerRadius", "outerRadius", "paddingAngle", "skipAnimation", "slotProps", "slots"];
var _excluded29 = ["startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "arcLabelRadius", "cornerRadius"];
  ...
  return (0, import_jsx_runtime62.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      let {
        ...
        arcLabelRadius: aLR,
        cornerRadius: cR
      } = _ref, style = _objectWithoutPropertiesLoose(_ref, _excluded29);
      return (0, import_jsx_runtime62.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PiePlot(props) {
  ...
  const seriesData = React61.useContext(SeriesContext).pie;
  const {
    left: left2,
    top: top2,
    width,
  ...
  return (0, import_jsx_runtime64.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime63.jsx)("g", {
        ...
        children: (0, import_jsx_runtime63.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime63.jsx)("g", {
        transform: `translate(${left2 + cx}, ${top2 + cy})`,
        children: (0, import_jsx_runtime63.jsx)(PieArcLabelPlot, {
          innerRadius,
...
function PieChart(props) {
  ...
  return (0, import_jsx_runtime66.jsxs)(ResponsiveChartContainer, {
    series: series.map((s2) => _extends({
      type: "pie"
    }, s2)),
    width,
    ...
    children: [(0, import_jsx_runtime65.jsx)(ChartsAxis, {
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime65.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime65.jsx)(ChartsTooltip, _extends({}, tooltip)), children]
  });
}
true ? PieChart.propTypes = {
   ...
   * @default null
   */
  bottomAxis: import_prop_types42.default.oneOfType([import_prop_types42.default.shape({
   ...
   * @default null
   */
  leftAxis: import_prop_types42.default.oneOfType([import_prop_types42.default.shape({
    axisId: import_prop_types42.default.oneOfType([import_prop_types42.default.number, import_prop_types42.default.string]),
    classes: import_prop_types42.default.object,
    disableLine: import_prop_types42.default.bool,
    disableTicks: import_prop_types42.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types42.default.oneOfType([import_prop_types42.default.shape({
    axisId: import_prop_types42.default.oneOfType([import_prop_types42.default.number, import_prop_types42.default.string]),
    classes: import_prop_types42.default.object,
    disableLine: import_prop_types42.default.bool,
    disableTicks: import_prop_types42.default.bool,
   ...
   * @default null
   */
  topAxis: import_prop_types42.default.oneOfType([import_prop_types42.default.shape({
    axisId: import_prop_types42.default.oneOfType([import_prop_types42.default.number, import_prop_types42.default.string]),
    classes: import_prop_types42.default.object,
    disableLine: import_prop_types42.default.bool,
    disableTicks: import_prop_types42.default.bool,
  ...
  xAxis: import_prop_types42.default.arrayOf(import_prop_types42.default.shape({
    ...
    position: import_prop_types42.default.oneOf(["bottom", "left", "right", "top"]),
...
function Scatter(props) {
  ...
  const highlightScope = React63.useMemo(() => _extends({
    highlighted: "item",
    faded: "global"
  ...
  const cleanData = React63.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
...
true ? Scatter.propTypes = {
  ...
  markerSize: import_prop_types43.default.number.isRequired,
  /**
   * Callback fired when clicking on a scatter item.
  ...
  xScale: import_prop_types43.default.func.isRequired,
  yScale: import_prop_types43.default.func.isRequired
} : void 0;
...
function ScatterPlot(props) {
  ...
  const seriesData = React64.useContext(SeriesContext).scatter;
  ...
  return (0, import_jsx_runtime68.jsx)(React64.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
...
var ScatterChart = React65.forwardRef(function ScatterChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime70.jsxs)(ResponsiveChartContainer, {
    ...
    yAxis,
    sx,
    children: [!disableVoronoi && (0, import_jsx_runtime69.jsx)(ChartsVoronoiHandler, {
      voronoiMaxRadius,
      onItemClick
    }), (0, import_jsx_runtime69.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), grid && (0, import_jsx_runtime69.jsx)(ChartsGrid, {
      vertical: grid.vertical,
      horizontal: grid.horizontal
    }), (0, import_jsx_runtime69.jsx)(ScatterPlot, {
      slots,
      slotProps,
      onItemClick: disableVoronoi ? onItemClick : void 0
    }), (0, import_jsx_runtime69.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime69.jsx)(ChartsAxisHighlight, _extends({
      x: "none",
      y: "none"
    }, axisHighlight)), (0, import_jsx_runtime69.jsx)(ChartsTooltip, _extends({
      trigger: "item"
    }, tooltip)), children]
  });
});
true ? ScatterChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types45.default.oneOfType([import_prop_types45.default.shape({
   ...
   * @default false
   */
  disableVoronoi: import_prop_types45.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
   ...
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types45.default.oneOfType([import_prop_types45.default.shape({
    axisId: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
    classes: import_prop_types45.default.object,
    disableLine: import_prop_types45.default.bool,
    disableTicks: import_prop_types45.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types45.default.oneOfType([import_prop_types45.default.shape({
    axisId: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
    classes: import_prop_types45.default.object,
    disableLine: import_prop_types45.default.bool,
    disableTicks: import_prop_types45.default.bool,
   ...
   * @default null
   */
  topAxis: import_prop_types45.default.oneOfType([import_prop_types45.default.shape({
    axisId: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
    classes: import_prop_types45.default.object,
    disableLine: import_prop_types45.default.bool,
    disableTicks: import_prop_types45.default.bool,
   ...
   * If `undefined`, the radius is assumed to be infinite.
   */
  voronoiMaxRadius: import_prop_types45.default.number,
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
  width: import_prop_types45.default.number,
...
var SparkLineChart = React66.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    width,
    height,
  ...
  return (0, import_jsx_runtime72.jsxs)(ResponsiveChartContainer, {
    ref,
    series: [_extends({
      type: plotType,
      data,
    ...
    }), plotType === "line" && (0, import_jsx_runtime72.jsxs)(React66.Fragment, {
...
true ? SparkLineChart.propTypes = {
   ...
   * @default false
   */
  area: import_prop_types46.default.bool,
   ...
   * @default 'linear'
   */
  curve: import_prop_types46.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
  /**
   * Data to plot.
   */
  data: import_prop_types46.default.arrayOf(import_prop_types46.default.number).isRequired,
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
   ...
   * @default 'line'
   */
  plotType: import_prop_types46.default.oneOf(["bar", "line"]),
  /**
   ...
   * @default false
   */
  showHighlight: import_prop_types46.default.bool,
  /**
   * Set to `true` to enable the tooltip in the sparkline.
   * @default false
   */
  showTooltip: import_prop_types46.default.bool,
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   */
  xAxis: import_prop_types46.default.shape({
...
var GaugeContext = React67.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function useGaugeState() {
  return React67.useContext(GaugeContext);
}
...
var GaugeContainer = React68.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
...
true ? GaugeValueText.propTypes = {
   ...
   * Height of a text line (in `em`).
   */
  lineHeight: import_prop_types48.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types48.default.bool,
...
function Gauge(props) {
  ...
  return (0, import_jsx_runtime79.jsxs)(GaugeContainer, _extends({}, other, {
    className: classes.root,
