...
export default function UserData() {
    ...
    const [emailTermAccepted, setEmailTermAccepted] = useState(
        userData.termOfEmail
    );
    ...
    const handleDeleteRequest = async () => {
        try {
            await addDoc(collection(firestore, "deletionRequests"), {
                ...
                userName: userData.dadoPessoal.nome,
                userEmail: currentUser.dadoPessoal.email,
    ...
    const handleDeleteFields = async () => {
        try {
            const userRef = doc(firestore, "user", currentUser.uid);
            await updateDoc(userRef, {
                'dadoPessoal.email': null,
                'dadoPessoal.nome': null,
                'dadoPessoal.phone': null,
                'dadoPessoal.foto': null,
                'dadoPessoal.ativo': false
            });
            await addDoc(collection(firestore, "deletionRequests"), {
                userId: currentUser.user.userId,
                userName: userData.user.dadoPessoal.nome,
                userEmail: currentUser.user.dadoPessoal.email,
                requestedAt: new Date(),
                status: "pending",
            });
