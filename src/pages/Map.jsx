...
export default function Map() {
  ...
  console.log(
    "Siglas dos Estados da Região Nordeste:",
    regioesDoBrasil.Nordeste
  );

  const handleSelectRegionChange = (element) => {
    console.log(
      "estados a serem exibidos",
      regioesDoBrasil[element.target.value]
    );
  ...
  const handleStateRemove = (itemToRemove) => {
    const newActiveStates = activeStates.filter(
            ...
            <div>
                ...
                <div>
                  <FormControl>
                    <FormLabel id="demo-row-radio-buttons-group-label">
                      Selecione os sentimentos que deseja analisar.
                    </FormLabel>
                    <RadioGroup
                      row
              ...
              <div>
                ...
                <div>
                  <FormControl>
                    <FormLabel id="demo-row-radio-buttons-group-label">
                      Selecione as regiões que você deseja analisar
                    </FormLabel>
                    <RadioGroup
                      row
                      aria-labelledby="demo-row-radio-buttons-group-label"
                ...
                <div>
                  <h2>Estados:</h2>
                  <h3>
                    Se preferir, escolha por estado desejado no mapa ao lado
                  </h3>
                  <div style={{ width: 550 }}>
                    <Stack
                      direction="row"
                    ...
                    >
                      {activeStates.map((estado) => (
                        <Chip
                          ...
                          key={estado}
                          variant="outlined"
                          onDelete={() => handleStateRemove(estado)}
                        />
                      ))}
                    </Stack>
                  </div>
